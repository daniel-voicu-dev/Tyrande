  ...
  return `
    <div class="ui-buttons ui-component">
      ...
      ${themedButtons.filter(o=>o.value.length !== 0).map(({label, value})=>{
        ...
        <div class="my-2 p-2 ui-block-code overflow-x-auto"><pre><<code></code>button type="button" class="btn-fill--${value[0]}">Fill Button<<code></code>/button></pre><pre><<code></code>button type="button" class="btn-border--${value[0]}">Border Button<<code></code>/button></pre></div>
